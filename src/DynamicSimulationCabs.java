...
public class DynamicSimulationCabs {
	...
	public static void main(String[] args) {
		...
		for (String net : networks)
			for (String algo : algorithms)
				for (long seed : seeds)
					new DynamicSimulationCabs(net, algo, seed, args);

		return;

	}

	public DynamicSimulationCabs(String network, String algorithm, long seed,
			String[] args) {
		System.out.println("----------");
...
//			NMI.init(graph);
			 ...
			 * Output file
			 */
			String output = "log_cabs/"
				+ getNetworkName(network) + "_" + algorithm + "_" + seed + ".log";
...
//				p.println("NMI = " + NMI.getMeasure());
				p.println("CC = " + CC.getConnectedComponentsCount(2));
				p.println("D = " + D);
				p.print(A);
				p.println("R = " + R);
